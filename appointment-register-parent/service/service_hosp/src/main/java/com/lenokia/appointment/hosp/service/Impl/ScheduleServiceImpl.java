...
import com.lenokia.appointment.hosp.repository.ScheduleRepository;
import com.lenokia.appointment.hosp.service.ScheduleService;
import com.lenokia.yygh.vo.hosp.BookingScheduleRuleVo;
...
//值copy不为null的值，该方法为自定义方法
    ...
    public Map<String, Object> getBookingScheduleRule(Integer page, Integer limit, String hoscode, String depcode) {
        ...
        Criteria criteria = Criteria.where("hoscode").is(hoscode).and("depcode").in(depcode)
        ...
        if(!CollectionUtils.isEmpty(scheduleVoList)) {
            scheduleRuleVoMap = scheduleVoList.stream().collect(Collectors.toMap(BookingScheduleRuleVo::getWorkDate,
