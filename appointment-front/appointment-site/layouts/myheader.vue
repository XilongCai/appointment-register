...
export default {
  ...
  methods:{
    ...
    login() {
      ...
      // this.setCookies('lenokia', 'eyJhbGciOiJIUzUxMiIsInppcCI6IkdaSVAifQ.H4sIAAAAAAAAAKtWKi5NUrJSiox099ANDXYNUtJRSq0oULIyNDMxMTIzNTGw1FEqLU4t8kwBikGYfom5qUAtOal5-dmZiUq1AA1xUGVEAAAA.1JpGpNv5N7fLLpYlzm5iQpG1Qtx-ckrAlD7oCFNmiBxqWWQFASKv5YmhejQN4r8QA1jVTAFU4GVCARwm8eJNGA')
    },
